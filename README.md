A USER BASED COLLABORATIVE FILTERING approach for recommending movies the users. This project uses the MovieLens dataset for evaluation and testing purposes.
